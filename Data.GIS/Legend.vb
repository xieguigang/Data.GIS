...
Public Module Legend
    ...
    <Extension>
    Public Function DrawLegend(designer As ColorDesigner, title$, Optional bg$ = "transparent") As Bitmap
        Return GraphicsPlots(
            New Size(800, 1000), New Size(50, 50), bg,
            Sub(ByRef g, grect)
                Call designer.__plot(g, grect, title$)
            End Sub)
    End Function

    <Extension>
    Private Sub __plot(designer As ColorDesigner, g As Graphics, grect As GraphicsRegion, title$)
